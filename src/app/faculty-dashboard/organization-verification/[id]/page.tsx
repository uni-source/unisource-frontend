...
import AccountInformationForm from '@/app/components/dashboard/faculty-dashboard/organization-verification/account-info/account-info';
import ProfileStats from '@/app/components/dashboard/faculty-dashboard/organization-verification/profile-stats/stat';
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3, marginTop: 8, '@media (max-width: 600px)': {
            ...
            <ProfileStats  id={params.id}/>
            <AccountInformationForm organizationId={params.id}/>
      </Box>
    </Box>
  );
};
